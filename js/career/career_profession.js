let carProData = {
    industry:[
        {typeName: "實作型(R)", backgroundColor: "#79BBB5", detail: [
            {name: "送貨人員", src: "./img/career/送貨人員.svg", info: "負責貨物的配送、裝卸及貨款回收", content: ";櫃檯接待、收發要運送的貨物;出、退、換貨作業事宜、清點貨物;運送貨物並保護貨物的完整;將貨品送到客戶手中，並請客戶進行簽收;供應商合約書相關協助作業處理", skill: ";包裹分區、堆疊、上車等物流相關事物;收發要運送的貨物;負責包裹分類與堆放作業;負責區域客戶開發、客情維護、市場資訊或顧客意見蒐集及包裹、文件收送服務;負責貨物統籌、配送、流通;配合公司安排運送貨物、協助客戶將貨品搬運入庫;配合支援到外點營業單位作調貨，送貨;須具備普通重型機車駕照;需具有職業小型車以上駕照，有職大貨以上駕照和相關經驗者;需具備職業大貨車(含)以上駕照"},
        ...
        {typeName: "社會型(S)", backgroundColor: "#f4c3c5", detail: [
            {name: "牙科助理", src: "./img/career/牙助.svg", info: "協助牙醫師從事牙齒口腔疾病診斷與治療時，牙醫器材設備及材料的準備", content: ";認識、學習操作及維修牙醫器材設備;指導患者做好口腔衛生及保健;協助牙醫師看診與檢驗", skill: ";顧客接待與需求服務;牙醫器材設備及材料之準備;執行疾病分類及病歷資料管理;製作病例管理相關報表;執行醫療機構行政庶務管理;提供解說或咨詢服務"},
            {name: "社工", src: "./img/career/社工.svg", info: "運用諮商技術、行為治療、團體心理治療等技巧，對社會生活功能有障礙的個人或家庭，提供治療性、矯治性或發展預防性的服務", content: ";個案輔導、團體帶領及社區資源整合連結服務;評估服務個案需求及擬定處遇計畫;撰寫方案計劃與執行成果報告;福利服務資源之發掘、組織、運用及服務網之建構、運作;個案入/出案評估、結案追蹤、轉銜服務;督導社工服務成效、協助解決問題與困難;督導及訓練社工之服務品質與審核相關服務紀錄;日常生活及身體照顧;進行身心功能及障礙程度評估", skill: ";通識知識;人類行為知識;社會工作方法;特殊人口群體知識"},
            {name: "老師", src: "./img/career/老師.svg", info: "又稱作教育工作者、教員，是大眾對教育從業者的稱呼，是培養社會所需人才的專業", content: ";擬定教學計畫;教學實務技巧;教學成果評量／評估;教導／輔導學生技巧;編寫上課講義;教材教具與教學媒體的運用;課程規劃與安排;資料蒐集、匯整與分析能力;結構業界實務經驗進行個案教學，讓學生與職場接軌", skill: ";倫理能力;智識能力;文化、社區與社會能力;教學能力;美學能力"},
        ...
        {typeName: "企業型(E)", backgroundColor: "#e7995f", detail: [
            {name: "保險業務", src: "./img/career/保險業務.svg", info: "透過專業分析，替顧客的人生分散風險", content: ";拜訪潛在顧客:替顧客風險事件發生時對經濟的衝擊，以及分析如何預先準備。;量身訂作保障:依不同需求及每個人可固定提撥的保費，量身訂作專屬保障內容。;協助理賠申請:風險發生時，協助顧客依照保單條款，準備相關文件，跟保險公司取得財務補償。", skill: ";不動產估價;不動產投資顧問;不動產租賃服務;不動產專業諮詢;不動產買賣仲介服務;依客戶個別情況及經濟景氣的變化，評估可能遇到的風險，行銷販售適合客戶需求的保險商品;保險相關業務諮詢，並提供最新的保險資訊，給客戶選擇並購買;契約內容變更、保單貸款辦理等相關業務;提供保險相關問題的諮詢，並協助規劃投保;業務行銷(金融保險商品規劃及服務)"},
            {name: "產品行銷人員", src: "./img/career/商品行銷.svg", info: "負責新產品行銷企劃案之撰寫、規劃與執行", content: ";蒐集市場情報，並擬定、分析行銷策略和價格策略。;規劃與產出行銷工具。;維護既有客戶，開發新客戶，並推展業務。", skill: ";執行市場與產品趨勢調查，提供開發單位作為新的參考;執行生企劃案的撰寫、規劃並從事有助於形象推廣工作;控管網站內容品質;產品說明文案發想及撰寫;規劃網路內容、服務及活動，並定期更新、維護及管理;進行商品管理、規劃、設計、推廣及開發協調;進行產業競爭力及市場調查分析;進行網路行銷及服務的成效追蹤;進行調查數據的彙整、除錯，分析調查數據與繪製統計圖表，並撰寫分析建議報告;實體店鋪市場行銷計畫擬定及執行"},
            {name: "賣場管理人員", src: "./img/career/樓管.svg", info: "賣場大小事都要知道，帶領大家持續成長", content: ";人員管理:需要管理店內員工的招募、出缺勤、業績、薪水、訓練、升遷。;商品管理:掌管商品的進出貨數量和品質。;制定銷售策略:思考如何讓商品賣得更好。例如：舉辦促銷活動。", skill: ";負責商品進貨入庫、銷售管理及庫存管理;負責銷售商品;商品進銷存退管理與執行，賣場商品陳列，販促佈置，設備清潔維護，顧客服務;商品管理(陳列、補貨、收貨驗收)及銷售服務;產品及服務標準化設計及營運相關執行;提供顧客之接待與需求服務(如：電話諮詢、調貨、修改、包裝及退換貨服務);短租營業推展及業務管理;賣場營業食品類商品補貨、備貨、排面整理及倉庫整理等;銷售人員招募及管理;銷售商品分析及商品管理，有百貨零售經驗佳，具備文書處理相關技能"},
            {name: "法務人員", src: "./img/career/法務人員.svg", info: "文書與相關契約撰擬及簽署,溝通協調公司各部門執行該專案", content: ";協助公司談判:公文書與相關契約撰擬及簽署,溝通協調公司各部門執行該專案。;協助公司遵循法令:偕同律師進行法律研究，並告知風險嚴重程度。;協助律師撰擬各式法律文件:如律師函,契約書,訴狀等。", skill: ";處理公司法務事務及提供公司業務之法律意見及解決方案;處理法令遵循事務及專案管理;處理洗錢防制事務;處理涉外專利訴訟，專利授權談判及相關專利爭議事務;提供法令/法律諮詢意見，以及法律專案執行;提供個人金融、財富管理專業法律諮詢意見;訴訟案件規劃處理;訴訟案件繕狀與開庭程序處理強制執行案件聲請及法院函文回覆執行案件追蹤與管控、假扣押提存取回作業行政事務案件處理;進行全行延滯授信案件法催程序，如：狀紙繕打、取得執行名義、強制執行程序或保全程序等;蒐集法令及處理法遵事務;需求單位契約審閱"}
        ]},
