let carProData = {
    industry:[
        ...
        {typeName: "研究型(I)", backgroundColor: "#a0cadb", detail: [
            ...
            {name: "研究人員", src: "./img/career/研究員.svg", info: "未歸類在其他社會學、人類學、哲學、歷史學及政治學等的研究人員，負責其他各領域的研究、執行與技術改良", content: ";研究計畫的構想、規劃以及計畫書的撰寫;其他類科學研究;對實驗結果進行測試改良;發表研究成果;技術建立與開發;技術應用、整合型計畫之研提;期刊論文發表能力;具備數字概念，擅長數據分析;統計軟體操作與運用", skill: ";自主學習與探索研究;快速瀏覽與掌握重點;找到各種研究間的缺失;測試理論的邊界條件;開始練習學術寫作;制訂計畫;管理時間;設計實驗;自行主導研究"},
        ...
        {typeName: "文藝型(A)", backgroundColor: "#ccc5e3", detail: [
            {name: "室內設計師", src: "./img/career/室內設計師.svg", info: "依據業主需求及經費預算，進行室內空間、設備、動線之規劃、並繪製平面配置圖與監督施工", content: ";配合屋主需求規劃空間，並協助添購裝修材料及家具產品設計等;與管線配置員討論將管線配置規劃進設計內;完成設計圖(平面圖、三視圖、立面圖、透視圖、管線圖等);規劃相關機電與消防系統，使業主居住更便利、安全且合法;專案簡報、監督施工人員完成室內裝潢工程;成本估算與訪價", skill: ";工程協調與問題處理;室內空間、設備、動線之規劃;裝修工程圖識圖;繪製施工圖與裝配圖;立體空間的陳列規劃;提供技術諮詢服務;基礎土木工程應用;工程品質管理;工程預算編製與控管;繪製2D╱3D模型設計圖;具備室內裝潢技術;機電與消防系統規劃"},
            {name: "攝影師", src: "./img/career/攝影師.svg", info: "操作相機或光學攝影器材，拍攝照片或影片", content: ";透過照相機及錄影器材進行人、事、物、景的關鍵影像存留;進行影像或照片編輯，將拍攝的影片或照片以某個題材呈現，達到特定效果;設備的調整、保養、維護;執行攝影工作、勘景、前後的準備工作及相關道具準備與燈光調整", skill: ";拍攝／採訪重要事件之進行狀況;影像輸出作業;執行攝影作業;操作使用各式相機及週邊設備;設備器材使用及維護;熟悉影片拍攝流程;影像設計處理;繪圖工具與軟體操作;數位影音剪輯;數位攝影技巧"},
            ...
            {name: "髮型師", src: "./img/career/理髮師.svg", info: "提供顧客相關的美髮資訊，並為顧客進行髮型的造型設計", content: ";顧客諮詢了解顧客需求;為顧客進行髮型及造型設計;修髮、洗髮及吹整髮型;燙髮、染漂頭髮、假髮設計;選用髮型裝飾品及配帶;臉部按摩、修剃及鬍鬚修整;提供顧客相關美髮的資訊", skill: ";熟悉美髮用品及功能;剪髮技術與髮型設計;美髮機器與器具使用;燙髮╱染髮設計;毛髮與皮膚基礎保養"}
        ]},
