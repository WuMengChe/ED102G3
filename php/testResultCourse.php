...
$relatedCourseSql = " select skill_class.SKI_NAME, skill_class.SKI_BUY_NUM, skill_class.SKI_PRICE,skill_class.SKI_TIME, skill_class.SKI_IMG,industry_class.IND_CLASS, industry_class.IND_COLOR FROM skill_class JOIN industry_class ON skill_class.IND_NO = industry_class.IND_NO WHERE industry_class.IND_NO = :IND_NO ";
