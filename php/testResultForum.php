...
$relatedDiscussSql = "select member.MEM_NAME, member.MEM_PIC, discuss_area.DIS_NO, discuss_area.DIS_NAME, discuss_area.DIS_CLASS, discuss_area.IND_NO, discuss_area.DIS_CONTENT , discuss_area.DIS_DATE, discuss_area.DIS_HIDDEN, industry_class.IND_COLOR FROM `discuss_area` JOIN industry_class ON discuss_area.IND_NO = industry_class.IND_NO JOIN member ON discuss_area.MEM_NO = member.MEM_NO where industry_class.IND_NO = :IND_NO";
