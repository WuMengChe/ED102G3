...
require_once('./connectMySql.php');
	$sql = "select * from `skill_class` WHERE SKI_NAME = '前端工程師就業養成班'"; 
	$skill = $pdo->query($sql);
...
<body>
    ...
    <div id="video" class="video">
        <iframe id="video-Cascade" class="i-frame" max-width="1200px" height="50vh" src="https://www.youtube.com/embed/ZavL9y4Adrk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    <?php
     while( $skill->fetch(PDO::FETCH_ASSOC)){//當抓得到一筆資料
	?>
	  <iframe id="video-Cascade" href="<?= $SKI_LINK ?>" class="i-frame" max-width="1200px" height="50vh" src="https://www.youtube.com/embed/ZavL9y4Adrk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	<?php
	}
	?>
    </div>
