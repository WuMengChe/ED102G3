...
try {
  ...
  //圖片一解碼
  // $quizImgOneSrc1 = str_replace('data:image/svg', '', $quizUp["quizImgOneSrc1"]);
  // $quizImgOneSrc1 = str_replace('xml;base64,', '', $quizImgOneSrc1);
  // $quizImgOneSrc1 = str_replace('DQo=', '', $quizImgOneSrc1);
