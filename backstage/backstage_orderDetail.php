...
try {
    ...
    $orderDetailSql = "select orddet.*, ski.SKI_NAME, ski.SKI_IMG,ski.SKI_TEC_NAME, ski.SKI_NO from order_detail orddet join skill_class ski on ski.SKI_NO = orddet.SKI_NO";
