...
require_once('./connectMySql.php');
	$sql = "select * from `skill_class` WHERE SKI_NAME = '翻轉課堂的職業講師祕訣'"; 
	$skill = $pdo->query($sql);
...
<body>
	...
	?>
        <h1 class="video_p2" href="<?= $SKI_NAME ?>">翻轉課堂的職業講師祕訣</h1>
	<?php
	}
	?>
    </div>
    ...
    <div id="video" class="video">
        <iframe id="video-Cascade" class="i-frame" max-width="1200px" height="50vh" src="https://www.youtube.com/embed/TliKR2AejnI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    <?php
     while( $skill->fetch(PDO::FETCH_ASSOC)){//當抓得到一筆資料
	?>
	  <iframe id="video-Cascade" href="<?= $SKI_LINK ?>" class="i-frame" max-width="1200px" height="50vh" src="https://www.youtube.com/embed/TliKR2AejnI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	<?php
	}
	?>
    </div>
